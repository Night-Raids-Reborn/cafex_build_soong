...
func Banner(make_vars map[string]string) string {
	b := &bytes.Buffer{}
        ...
        fmt.Fprintln(b, "                                                            ")
        fmt.Fprintln(b, "============================================================")
        fmt.Fprintln(b, "                         CAF-Extended                       ")
        fmt.Fprintln(b, "============================================================")
	fmt.Fprintf(b, "%s=%s\n", "CAFEX_VERSION", make_vars["CAFEX_VERSION"])
	fmt.Fprintf(b, "%s=%s\n", "CAFEX_BUILD_TYPE", make_vars["CAFEX_BUILD_TYPE"])
	fmt.Fprintf(b, "%s=%s\n", "CAFEX_BUILD_VARIANT", make_vars["CAFEX_BUILD_VARIANT"])
